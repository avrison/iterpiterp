...
class Admin_Menu {
    ...
    public function admin_menu() {
        ...
        $overview = add_submenu_page( 'erp-sales', __( 'Overview', 'erp' ), __( 'DASBOARD', 'erp' ), 'erp_crm_manage_dashboard', 'erp-sales', [ $this, 'dashboard_page' ] );
        add_submenu_page( 'erp-sales', __( 'Companies', 'erp' ), __( 'DAFTAR COMPANY', 'erp' ), 'erp_crm_list_contact', 'erp-sales-companies', [ $this, 'company_page' ] );
        add_submenu_page( 'erp-sales', __( 'Activities', 'erp' ), __( 'AKTIFITAS SALES', 'erp' ), 'erp_crm_manage_activites', 'erp-sales-activities', [ $this, 'activity_page' ] );
        $schedule = add_submenu_page( 'erp-sales', __( 'Schedules', 'erp' ), __( 'MY SCHEDULE', 'erp' ), 'erp_crm_manage_schedules', 'erp-sales-schedules', [ $this, 'schedules_page' ] );
        add_submenu_page( 'erp-sales', __( 'Kontak Groups', 'erp' ), __( 'SEGMENT / INDUSTRI', 'erp' ), 'erp_crm_manage_groups', 'erp-sales-contact-groups', [ $this, 'contact_group_page' ] );
        add_submenu_page( 'erp-sales', __( 'Title 1', 'erp' ), __( 'Menu1', 'erp' ), 'erp_crm_manage_groups', 'erp-sales-contact-groups', [ $this, 'company_page' ] );
        add_submenu_page('erp-sales', __('Title 2','erp'), __('Menu2','erp'),'erp_crm_manage_activites','erp-sales-activities', [$this,'activity_page'] );
