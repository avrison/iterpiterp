    ...
    ;jQuery(document).ready(function($) {
        $('#erp-crm-schedule-calendar').fullCalendar({
            ...
            dayClick: function(date, jsEvent, view) {
                ...
                $.erpPopup({
                    title: ( new Date( date) < new Date() ) ? '<?php _e( 'Tambahkan log jadwal', 'erp' ) ?>' : '<?php _e( 'Add new Schedule', 'erp' ); ?>',
                    button: ( new Date( date) < new Date() ) ? '<?php _e( 'Create Jadwal', 'erp' ) ?>' : '<?php _e( 'Create Schedule', 'erp' ); ?>',
