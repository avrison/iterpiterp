            ...
            <div class="col-2 column-left erp-single-customer-row" id="erp-customer-details">
                <div class="left-content">
                    ...
                    <div class="postbox customer-basic-info">
                        ...
                        <div class="inside">
                            <ul class="erp-list separated">
                                ...
                                <li><?php erp_print_key_value( __( 'Jabatan', 'erp' ), $customer->get_last_name() ); ?></li>
                                <li><?php erp_print_key_value( __( 'Awal Kontak', 'erp' ), $customer->get_birthday() ); ?></li>
                                <li><?php erp_print_key_value( __( 'Awal Kontaker', 'erp' ), $customer->get_contact_age() ); ?></li>
                                <li><?php erp_print_key_value( __( 'Phone', 'erp' ), $customer->get_phone() ); ?></li>
                                <li><?php erp_print_key_value( __( 'Company', 'erp' ), $customer->get_fax() ); ?></li>
                    ...
                    <contact-company-relation
                        ...
                        add-button-txt="<?php _e( 'Tetapkan company', 'erp' ) ?>"
