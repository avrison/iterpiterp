...
<div id="tasks">
    ...
    <div class="assign-task-wrap">
        <p class="assign-task-title">
            <input type="text" v-model="feedData.task_title" placeholder="<?php _e( 'Masukkan Tipe Action Selanjutnya..') ?>">
        </p>
        <p class="assign-taskes-users">
            <select name="selected_contact" v-model="feedData.inviteContact" v-selecttwo="feedData.inviteContact" class="select2" multiple="multiple" style="width: 100%" data-placeholder="Pilih Kontak ...">
        ...
        <div class="assign-task-datetime">
            <p class="erp-left assign-task-date">
                <input v-model="feedData.dt" type="text" v-datepicker="feedData.dt" datedisable="previous" placeholder="pilih tanggal">
            </p>
