<div class="erp-customer-form">
    ...
    <fieldset>
        <legend><?php _e( 'Info Lainnya', 'erp' ) ?></legend>
...
-->
    ...
    <fieldset>
        <legend><?php _e( 'Info Tambahan', 'erp' ) ?></legend>
    ...
    <fieldset>
       <legend><?php _e( ' Sosial media', 'erp' ) ?></legend>
