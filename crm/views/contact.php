...
<div class="wrap erp-crm-customer erp-crm-customer-listing" id="wp-erp" v-cloak>
    ...
    <h2>
        ...
        <?php if ( current_user_can( 'erp_crm_add_contact' ) ): ?>
            <a href="#" @click.prevent="addContact( 'contact', '<?php _e( 'Tambahkan Kontak', 'erp' ); ?>' )" id="erp-customer-new" class="erp-contact-new add-new-h2"><?php _e( 'Tambahkan Kontak', 'erp' ); ?></a>
        <?php endif ?>
