...
<div class="wrap erp erp-crm-activities erp-single-customer" id="wp-erp">
    ...
    <h2><?php _e( 'SALES COMMUNICATION RECORD', 'erp' ); ?></h2>
    <hr>
    <div class="erp-customer-feeds" id="erp-customer-feeds" v-cloak>
        ...
        <div class="activity-filter" id="erp-crm-activities-filter">
            ...
            <div class="filters">
                <select style="width:180px;" v-selecttwo="filterFeeds.type" class="select2" v-model="filterFeeds.type" id="activity-type" data-placeholder="<?php _e( 'Pilih Aktifitas', 'erp' ) ?>">
            ...
            <div class="filters">
                <select style="width:260px;" v-selecttwo="filterFeeds.created_by" class="select2" v-model="filterFeeds.created_by" id="activity-created-by" data-placeholder="<?php _e( 'Created by..', 'erp' ) ?>">
                    <option value="-1"><?php _e( 'Sales Person', 'erp' ) ?></option>
            ...
            <div class="filters">
                <select style="width:260px;" v-selecttwo="filterFeeds.customer_id" data-types="contact,company"  class="erp-crm-contact-list-dropdown" v-model="filterFeeds.customer_id" id="activity-created-for"  data-placeholder="<?php _e( 'Pilih Company', 'erp' ) ?>">
                    <option value=""></option>
                </select>
            </div>

            <div class="filters">
                <input type="search" v-datepicker v-model="filterFeeds.created_at" placeholder="<?php _e( 'Pilih Tanggal..', 'erp' ); ?>">
            </div>
        ...
        <div class="activity-content">
            ...
            <div class="no-activity-found" v-if="!feeds.length">
                <?php _e( 'Ooops..Tidak ada aktifitas...  +_+', 'erp' ); ?>
            </div>
