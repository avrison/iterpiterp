<div class="wrap erp erp-crm-customer erp-single-customer" id="wp-erp">
    ...
    <h2><?php _e( 'SALES COMMUNICATION RECORD #', 'erp' ); echo $customer->id; ?>
        <a href="<?php echo add_query_arg( ['page' => 'erp-sales-companies'], admin_url( 'admin.php' ) ); ?>" id="erp-contact-list" class="add-new-h2"><?php _e( 'Kembali ke Listing Company', 'erp' ); ?></a>

        <?php if ( current_user_can( 'erp_crm_edit_contact', $customer->id ) || current_user_can( erp_crm_get_manager_role() ) ): ?>
            <span class="edit">
                <a href="#" @click.prevent="editContact( 'company', '<?php echo $customer->id; ?>', '<?php _e( 'Edit this company', 'erp' ); ?>' )" data-id="<?php echo $customer->id; ?>" data-single_view="1" title="<?php _e( 'Edit Data Company', 'erp' ); ?>" class="add-new-h2"><?php _e( 'Edit Data Company', 'erp' ); ?></a>
            </span>
            ...
            <div class="col-2 column-left erp-single-customer-row">
                ...
                <div class="left-content">
                    ...
                    <div class="postbox customer-basic-info">
                        ...
                        <h3 class="erp-hndle"><span><?php _e( 'DEATAIL INFO COMPANY', 'erp' ); ?></span></h3>
                        <div class="inside">
                            <ul class="erp-list separated">
                                <li><?php erp_print_key_value( __( 'Nama Company', 'erp' ), $customer->get_full_name() ); ?></li>
                                ...
                                <li><?php erp_print_key_value( __( 'Alamat', 'erp' ), $customer->get_street_1() ); ?></li>
                                <li><?php erp_print_key_value( __( 'Potensi Bisnis', 'erp' ), $customer->get_street_2() ); ?></li>
                                <li><?php erp_print_key_value( __( 'Kota', 'erp' ), $customer->get_city() ); ?></li>
                                <li><?php erp_print_key_value( __( 'Provinsi', 'erp' ), $customer->get_state() ); ?></li>
                                <li><?php erp_print_key_value( __( 'Negara', 'erp' ), $customer->get_country() ); ?></li>
                                <li><?php erp_print_key_value( __( 'Kode pos', 'erp' ), $customer->get_postal_code() ); ?></li>
                    ...
                    <contact-assign-group
                        ...
                        add-button-txt="<?php _e( 'Tetapkan Grup Kontak', 'erp' ) ?>"
